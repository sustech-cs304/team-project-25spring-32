...
public class PhotoinAlbumActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("PhotoInAlbumActivity", "album_name: " + currentAlbumName);
        isAutoGenerated = getIntent().getBooleanExtra("album_type", false);
        Log.d("PhotoInAlbumActivity", "album_type: " + isAutoGenerated);

        // 加载PhotoinAlbumFragment到容器
        if (savedInstanceState == null) {
            PhotoinAlbumFragment fragment = PhotoinAlbumFragment.newInstance(currentAlbumName, isAutoGenerated);
        ...
        if (isAutoGenerated | currentAlbumName.equals("All Photos")) {
