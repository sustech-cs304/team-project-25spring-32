...
public class MusicRepository {
    ...
    public List<MusicItem> getMusicList(Context context) {
        ...
        // Uri music1Uri = Uri.parse("android.resource://" + context.getPackageName() + "/" + R.raw.gentle_breeze);
        // musicList.add(new MusicItem(context.getString(R.string.music_gentle_breeze), music1Uri));
