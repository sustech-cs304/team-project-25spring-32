...
//            return db.insert(TABLE_NAME, null, values);
    ...
    // 获取或创建相册
    public int getOrCreateAlbum(String albumName, int userId, Map<String, Integer> cache, boolean isAutoGenerated) {
        ...
        if (cursor != null && cursor.moveToFirst()) {
            ...
            long albumId = addAlbum(albumName, userId, isAutoGenerated,
